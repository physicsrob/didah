  ...
  calculateStats(events: LogEvent[], config: SessionConfig): SessionStatisticsWithMaps {
    ...
    const baseStats = {
      ...
      config: {
        ...
        listenTimingOffset: config.listenTimingOffset,
        characterSpeed: config.characterSpeed,
        learnLevel: config.learnLevel,
        learnUnmasteredChars: config.learnUnmasteredChars,
      },
      overallAccuracy,
      timeoutPercentage,
      achievedWpm,
