...
describe('handlePracticeCharacter - integration', () => {
  ...
  it('updates stats and history for correct input', async () => {
    ...
    const handlerPromise = handlePracticeCharacter(config, 'A', startTime, ctx, signal.signal);
  ...
  it('updates stats and history for timeout', async () => {
    ...
    // Start handler
    const handlerPromise = handlePracticeCharacter(config, 'B', startTime, ctx, signal.signal);
  ...
  it.skip('throws error if practiceState not initialized', async () => {
    ...
    // Start the handler
    const handlerPromise = handlePracticeCharacter(config, 'C', clock.now(), ctx, signal.signal);
  ...
  it('publishes snapshot after completing emission', async () => {
    ...
    const handlerPromise = handlePracticeCharacter(config, 'D', clock.now(), ctx, signal.signal);
  ...
  it('handles replay when enabled and outcome is incorrect', async () => {
    ...
    const handlerPromise = handlePracticeCharacter(config, 'E', clock.now(), ctx, signal.signal);
